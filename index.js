...
app.use(cors({
    origin:['http://localhost:3000', '*', 'https://master.d3ldsmi1fd1rti.amplifyapp.com','https://www.pioneervalleytagalog.org', 'https://pioneervalleytagalog.org'],
    methods:['POST'],
...
app.post('/',jsonParser, async function (req, res) {
 ...
 app.post('/loadSchedule',jsonParser, async function (req, res) {
    var isScheduleDataCached = false;
    var scheduleObj;
    var assignmentObj;
